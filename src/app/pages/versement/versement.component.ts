...
@Component({
    ...
    standalone: true,
    imports: [NavActionsComponent, BtnMenuComponent, BtnComponent, ContentComponent, NgClass, CardComponent, InfosContextComponent, SpinnerComponent, InfosDossierComponent, NotificationComponent, TeleportComponent, AutreDeviseComponent, InfosBeneficiaireComponent, SelectBeneficiaireComponent]
})
